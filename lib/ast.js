...
(function() {
  var AST, ASTRegExp, ArrayExp, AssignExp, BinaryExp, BlockExp, BoolExp, DateExp, DefineExp, Environment, FloatExp, IfExp, IntegerExp, MemberExp, NullExp, ObjectExp, ParameterExp, ProcedureCallExp, ProcedureExp, StringExp, SymbolExp, UnaryExp, UndefinedExp,
  ...
  AST = (function() {
    ...
    AST.define = function(ctor) {
      var name;
      name = ctor.type;
      return this.baseEnv.define(name, ctor);
    };

    AST.get = function(name) {
      return this.baseEnv.get(name);
    };
  ...
  AST.define(IntegerExp = (function(superClass) {
    extend(IntegerExp, superClass);

    IntegerExp.type = 'integer';
  ...
  AST.define(FloatExp = (function(superClass) {
  ...
  AST.define(BoolExp = (function(superClass) {
    extend(BoolExp, superClass);

    BoolExp.type = 'boolean';
  ...
  AST.define(StringExp = (function(superClass) {
    extend(StringExp, superClass);

    StringExp.type = 'string';
  ...
  AST.define(DateExp = (function(superClass) {
  ...
  AST.define(NullExp = (function(superClass) {
  ...
  AST.define(UndefinedExp = (function(superClass) {
    extend(UndefinedExp, superClass);

    UndefinedExp.type = 'undefined';
  ...
  AST.define(SymbolExp = (function(superClass) {
    extend(SymbolExp, superClass);

    SymbolExp.type = 'symbol';
  ...
  AST.define(ASTRegExp = (function(superClass) {
    extend(ASTRegExp, superClass);

    ASTRegExp.type = 'regex';
  ...
  AST.define(ArrayExp = (function(superClass) {
  ...
  AST.define(ObjectExp = (function(superClass) {
    extend(ObjectExp, superClass);

    ObjectExp.type = 'object';
    ...
    function ObjectExp(keyvals) {
      ...
      for (i = j = 0, len = keyvals.length; j < len; i = ++j) {
        ...
        if (!((keyval[0] instanceof AST.get('string')) || (keyval[0] instanceof AST.get('symbol')))) {
  ...
  AST.define(MemberExp = (function(superClass) {
    extend(MemberExp, superClass);

    MemberExp.type = 'member';
    ...
    function MemberExp(head, key) {
      ...
      if (!(key instanceof AST.get('symbol'))) {
  ...
  AST.define(UnaryExp = (function(superClass) {
    ...
    function UnaryExp(op, rhs) {
      ...
      if (!(op instanceof AST.get('symbol'))) {
  ...
  AST.define(BinaryExp = (function(superClass) {
    extend(BinaryExp, superClass);

    BinaryExp.type = 'binary';
  ...
  AST.define(IfExp = (function(superClass) {
  ...
  AST.define(BlockExp = (function(superClass) {
  ...
  AST.define(ProcedureCallExp = (function(superClass) {
    extend(ProcedureCallExp, superClass);

    ProcedureCallExp.type = 'procedureCall';
  ...
  AST.define(ProcedureExp = (function(superClass) {
    extend(ProcedureExp, superClass);

    ProcedureExp.type = 'procedure';
    ...
    function ProcedureExp(name, args, body) {
      ...
      if (!((name === null) || (name instanceof AST.get('symbol')))) {
      ...
      for (i = j = 0, len = args.length; j < len; i = ++j) {
        arg = args[i];
        if (!(arg instanceof AST.get('param'))) {
  ...
  AST.define(DefineExp = (function(superClass) {
    extend(DefineExp, superClass);

    DefineExp.type = 'define';
  ...
  AST.define(AssignExp = (function(superClass) {
    extend(AssignExp, superClass);

    AssignExp.type = 'assign';
